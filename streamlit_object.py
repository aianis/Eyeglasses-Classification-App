    ...
    while run_app:
        ...
        while(cap.isOpened()):
            ...
            for i, rect in enumerate(rects):
                ...
                cv2.putText(img, "{}".format(i + 1), (x_face - 10, y_face - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2, cv2.LINE_AA)
                ...
                if judge == True:
                    ...
                    cv2.putText(img, "Without Glasses", (x_face + 100, y_face - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2, cv2.LINE_AA)
